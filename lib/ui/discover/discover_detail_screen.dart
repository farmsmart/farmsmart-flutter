...
Widget buildRelated(BuildContext context, List<ArticleEntity> articlesList,
    getRelatedArticles) {
  ...
  return Column(
      ...
      children: (articlesList != null)
          ? (articlesList
              .map((article) =>
                  buildListOfRelatedArticles(article, getRelatedArticles))
              .toList())
          : null);
}
