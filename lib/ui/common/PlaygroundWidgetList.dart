...
class PlaygroundWidgetList {
  ...
  static List<Widget> completeListOfWidgets = [
    ...
    ActionSheet(viewModel: MockActionSheetViewModel.buildStandard(), style: ActionSheetStyle.defaultStyle(), cellStyle: ActionSheetListItemStyle.defaultStyle()),
    ActionSheet(viewModel: MockActionSheetViewModel.buildStandardBigger(), style: ActionSheetStyle.defaultStyle(), cellStyle: ActionSheetListItemStyle.defaultStyle()),
    ActionSheet(viewModel: MockActionSheetViewModel.buildWithIcon(), style: ActionSheetStyle.defaultStyle(), cellStyle: ActionSheetListItemStyle.defaultStyle()),
