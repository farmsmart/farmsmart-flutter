...
class _MyPlotState extends State<PlotList> {
  ...
  Widget _buildPage(BuildContext context, List<CropEntity> cropList,
    ...
    return HeaderAndFooterListView.builder(
        ...
        footer: RoundedButton.build(RoundedButtonViewModel(context, title: viewModel.buttonTitle, onTap: _showToast),
    ...
    return Container(
        ...
        child: Row(
            ...
            children: <Widget>[
              ...
              RoundedButton.build(
                  RoundedButtonViewModel(context, icon: "assets/icons/profit_add.png", onTap: _showToast),
